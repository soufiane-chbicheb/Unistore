...
const faqs = [
  {
    ...
    answer: "Our free trial gives you full access to all Unistore features for 14 days. No credit card required. At the end of the trial, you can choose a plan that suits your needs or cancel without any charges."
  },
  {
