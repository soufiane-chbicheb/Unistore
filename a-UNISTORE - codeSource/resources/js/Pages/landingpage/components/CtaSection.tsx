...
const CtaSection = () => {
  return (
    <div id="contact" className="bg-saas-darkGray py-16 md:py-20">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="md:w-2/3">
              ...
              <Button
                ...
                onClick={() => window.open('https://wa.me/15551417604?text=Hello!%20I%20would%20like%20to%20contact%20support%20please.', '_blank')}              >
                Contact support
              </Button>
              </div>
            </div>
